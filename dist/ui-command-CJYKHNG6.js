...
async function handleManualModel(req, res, action) {
  ...
  try {
    const { addManualModel, removeManualModel } = await import("./manual-models-XV4TB7FB.js");
...
async function handleAddProvider(req, res) {
  try {
    ...
    const { listSupportedTemplates } = await import("./provider-templates-WXVGL4XE.js");
...
//# sourceMappingURL=ui-command-CJYKHNG6.js.map